...
![Syncopation copying a music folder to an SD card](docs/screenshot.png)
...
- **Check First** — a dry run listing exactly what would be copied.
...
4. Click **Check First** to see what would happen, then **Sync**.
